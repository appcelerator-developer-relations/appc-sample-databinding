/**
 * Great addon to make some platform-specific UI elements cross platform
 * Read more about it in the docs: https://github.com/jasonkneen/UTiL/blob/master/docs/xp.ui.md
 */
if (!OS_IOS) {
